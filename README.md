...
In collaboration with Fong Chan ([@tinyheero](https://github.com/tinyheero)) and Lu Zhang (Emory University), the latest release (v0.2.1) of `plotGMM` includes substantial updates with easy-to-use tools for visualizing output from univariate Gaussian mixture models: 
